...
class PrivoxyBlocklist < Formula
  ...
  def install
    ...
    ENV.prepend_path "PATH", Formula['privoxy'].sbin
...
__END__
diff --git i/privoxy-blocklist.sh w/privoxy-blocklist.sh
index e26b01d..bb72df6 100755
--- i/privoxy-blocklist.sh
+++ w/privoxy-blocklist.sh
